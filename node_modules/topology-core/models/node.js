...
var Node = /** @class */ (function (_super) {
    ...
    Node.prototype.calcChildRect = function (parent) {
        ...
        var x = parent.rect.x +
            ...
            utils_1.abs(parentW, this.rectInParent.x) +
            utils_1.abs(parentW, this.rectInParent.marginLeft);
        var y = parent.rect.y +
            parent.paddingTopNum +
            utils_1.abs(parentH, this.rectInParent.y) +
            utils_1.abs(parentW, this.rectInParent.marginTop);
    ...
    Node.prototype.drawImg = function (ctx) {
        ...
        this.img.onload = function () {
            ...
            _this.imgNaturalHeight = _this.img.naturalHeight;
            // this.drawImg(ctx);
